...
\lstset{language=Java, basicstyle=\ttfamily\footnotesize, caption={CRUD-Operationen Neo4j Core API}, label=list:neo4j_api_example}
\begin{lstlisting}
...
\begin{lstlisting}
// get all nodes reachable from user id 23 with edge restrictions
try (Transaction tx = graphDB.beginTx()) {
