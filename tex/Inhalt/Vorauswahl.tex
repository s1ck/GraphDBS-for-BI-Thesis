...
Ein wichtiges Kriterium für das Forschungsprojekt ist die dauerhafte Speicherung der Datenbasis, eine native Speicherung des Graphen ist dabei nicht zwingend erforderlich. Eine rein hauptspeicher-zentrierte Verarbeitung und die damit verbundene höhere Performance beim wahlfreien Zugriff innerhalb des Graphen kann insbesondere für analytische Systeme vorteilhaft sein, wird jedoch bisher nur von wenigen Systemen angeboten und ist daher optional. Indexstrukturen hingegen werden als obligatorisch deklariert, da sie auch in umfangreichen Graphen den effizienten Zugriff auf Knoten- und Kantenmengen anhand deren Attribute ermöglichen.
