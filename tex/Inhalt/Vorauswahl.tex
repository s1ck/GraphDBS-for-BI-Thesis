...
In der letzten Kategorie werden die verbliebenen fünf Systeme hinsichtlich ihrer Fähigkeit zur Datenverteilung gegenübergestellt. Das fehlertolerante Speichern ist insbesondere in Verbindung mit Unternehmensdaten wünschenswert, eine hingegen für die Analyse wichtigere Anforderung ist die Skalierbarkeit von Lesezugriffen. Beides kann durch eine Replikation der Datenbasis erreicht werden, deren Unterstützung durch das entsprechende GDBMS gewährleistet sein soll. Darüber hinaus können Unternehmensdaten entweder von Beginn an sehr umfangreich sein bzw. durch stetiges Wachstum einen Umfang erreichen, der ihre Partitionierung erfordert. Da nur sehr wenige der Systeme eine Partitionierung der Datenbasis unterstützen, wird diese Anforderung als optional deklariert.
