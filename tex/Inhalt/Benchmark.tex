...
- Boxplot begründen (Graph -> gradverteilung usw.)
- maximalwerte angeben (insbesondere bei Pfadanfragen)

\paragraph*{\texttt{random\_read}}
...
\paragraph*{\texttt{path\_shortest}}
